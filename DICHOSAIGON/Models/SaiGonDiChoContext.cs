...
{
    public partial class SaiGonDiChoContext : DbContext
    {
        public SaiGonDiChoContext()
        {
        }

        public SaiGonDiChoContext(DbContextOptions<SaiGonDiChoContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=LAPTOP-5LK6RF58\\SONGOLUU; Database=SaiGonDiCho; Integrated Security=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Location>(entity =>
            {
                ...
                entity.Property(e => e.Idhuyen).HasColumnName("IDHuyen");
